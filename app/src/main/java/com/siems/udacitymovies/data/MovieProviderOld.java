...
public class MovieProviderOld extends ContentProvider {
    public static final String LOG_TAG = MovieProviderOld.class.getSimpleName();
    ...
    public static UriMatcher createUriMatcher() {
        ...
        String authority = MovieContractOld.CONTENT_AUTHORITY;

        matcher.addURI(authority, MovieContractOld.PATH_MOVIE, MOVIE);
        matcher.addURI(authority, MovieContractOld.PATH_MOVIE + "/#", MOVIE_WITH_ID);
        matcher.addURI(authority, MovieContractOld.PATH_MOVIE + "/*", MOVIE_WITH_POSTER);

        matcher.addURI(authority, MovieContractOld.PATH_TRAILER, TRAILER);
        matcher.addURI(authority, MovieContractOld.PATH_TRAILER + "/#", TRAILER_WITH_MOVIE_ID);

        matcher.addURI(authority, MovieContractOld.PATH_REVIEW, REVIEW);
        matcher.addURI(authority, MovieContractOld.PATH_REVIEW + "/#", REVIEW_WITH_MOVIE_ID);
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (match) {
            ...
            case MOVIE_WITH_POSTER:
                String posterUrl = MovieContractOld.MovieEntry.getPosterUrlFromUri(uri);
                Log.d(LOG_TAG, "poster url: " + posterUrl);
                cursor = db.query(
                        MovieContractOld.MovieEntry.TABLE_NAME,
                        projection,
                        MovieContractOld.MovieEntry.COLUMN_POSTER_PATH + " = ?",
            ...
            case MOVIE_WITH_ID: {
                long _id = MovieContractOld.MovieEntry.getIdFromUri(uri);
                cursor = db.query(
                        MovieContractOld.MovieEntry.TABLE_NAME,
                        projection,
                        MovieContractOld.MovieEntry._ID + " = ?",
            ...
            case TRAILER:
                cursor = db.query(
                        MovieContractOld.TrailerEntry.TABLE_NAME,
                        projection,
                        selection,
                        selectionArgs,
                        null,
            ...
            case TRAILER_WITH_MOVIE_ID: {
                long _id = MovieContractOld.TrailerEntry.getMovieIdFromUri(uri);
                cursor = db.query(
                        MovieContractOld.TrailerEntry.TABLE_NAME,
                        projection,
                        MovieContractOld.TrailerEntry.COLUMN_MOVIE_ID + " = ?",
                        new String[]{Long.toString(_id)},
                        null,
                        null,
                        sortOrder);
            ...
            case REVIEW:
                cursor = db.query(
                        MovieContractOld.ReviewEntry.TABLE_NAME,
                        projection,
                        selection,
                        selectionArgs,
                        null,
            ...
            case REVIEW_WITH_MOVIE_ID: {
                long _id = MovieContractOld.ReviewEntry.getMovieIdFromUri(uri);
                cursor = db.query(
                        MovieContractOld.ReviewEntry.TABLE_NAME,
                        projection,
                        MovieContractOld.ReviewEntry.COLUMN_MOVIE_ID + " = ?",
                        new String[]{Long.toString(_id)},
                        null,
                        null,
                        sortOrder);
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            case MOVIE_WITH_POSTER:
                return MovieContractOld.MovieEntry.CONTENT_ITEM_TYPE;

            case MOVIE_WITH_ID:
                return MovieContractOld.MovieEntry.CONTENT_ITEM_TYPE;

            case REVIEW:
                return MovieContractOld.ReviewEntry.CONTENT_TYPE;

            case REVIEW_WITH_MOVIE_ID:
                return MovieContractOld.ReviewEntry.CONTENT_ITEM_TYPE;

            case TRAILER:
                return MovieContractOld.TrailerEntry.CONTENT_TYPE;

            case TRAILER_WITH_MOVIE_ID:
                return MovieContractOld.TrailerEntry.CONTENT_ITEM_TYPE;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            case MOVIE:
                ...
                if (insertedId > 0) {
                    insertionUri = MovieContractOld.MovieEntry.buildMovieWithId(insertedId);
                } else {
            ...
            case TRAILER:
                insertedId = db.insert(MovieContractOld.TrailerEntry.TABLE_NAME, null, values);
                if (insertedId > 0) {
                    insertionUri = MovieContractOld.TrailerEntry.buildTrailerWithId(insertedId);
                } else {
                    throw new SQLException("Failed to insert row into " + uri);
                }
                break;
            ...
            case REVIEW:
                insertedId = db.insert(MovieContractOld.ReviewEntry.TABLE_NAME, null, values);
                if (insertedId > 0) {
                    insertionUri = MovieContractOld.ReviewEntry.buildTrailerWithId(insertedId);
                } else {
                    throw new SQLException("Failed to insert row into " + uri);
                }
                break;
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case MOVIE:
                rowsDeleted = db.delete(MovieContractOld.MovieEntry.TABLE_NAME, selection, selectionArgs);
                break;

            case TRAILER:
                rowsDeleted = db.delete(MovieContractOld.TrailerEntry.TABLE_NAME, selection, selectionArgs);
                break;
        ...
        switch (matcher) {
            case MOVIE: {
                ...
                for (ContentValues item : values) {
                    long _id = db.insert(MovieContractOld.MovieEntry.TABLE_NAME, null, item);
                    if (_id != -1) {
                        count++;
                    }
                }
            ...
            case REVIEW: {
                ...
                try {
                    for (ContentValues item : values) {
                        long _id = db.insert(MovieContractOld.ReviewEntry.TABLE_NAME, null, item);
                        if (_id != -1) {
                            returnCount++;
                        }
                    }
            ...
            case TRAILER: {
                ...
                try {
                    for (ContentValues item : values) {
                        long _id = db.insert(MovieContractOld.TrailerEntry.TABLE_NAME, null, item);
                        if (_id != -1) {
                            returnCount++;
                        }
                    }
